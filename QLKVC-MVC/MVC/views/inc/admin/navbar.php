        ...
        <div class="container-fluid">
            <div class="d-flex align-items-center justify-content-between w-100">
                <div class="d-flex align-items-center"><a
                        ...
                        <div class="brand-text d-none d-md-inline-block text-uppercase letter-spacing-0"><strong
                                class="text-primary text-sm">BẢNG ĐIỀU KHIỂN</strong></div>
                    </a></div>
                <ul class="nav-menu mb-0 list-unstyled d-flex flex-md-row align-items-md-center">
                    ...
                    <!-- <li class="nav-item dropdown"> <a class="nav-link text-white position-relative" id="notifications"
                            ...
                            </svg><span class="badge bg-warning">99+</span></a>
                    ...
                    <!-- <li class="nav-item dropdown"> <a class="nav-link text-white position-relative" id="messages"
                        ...
                        <ul class="dropdown-menu dropdown-menu-end mt-sm-3 shadow-sm" aria-labelledby="messages">
                            <li><a class="dropdown-item d-flex py-3" href="#!"> <img
                                        ...
                                        src="<?php echo WEB_ROOT; ?>public/assets/admin/img/avatar-1.jpg" alt="..."
                                        width="45">
                                    <div class="ms-3"><span
                            ...
                            <li><a class="dropdown-item d-flex py-3" href="#!"> <img
                                        class="img-fluid rounded-circle flex-shrink-0 avatar shadow-0"
                                        src="<?php echo WEB_ROOT; ?>public/assets/admin/img/avatar-2.jpg" alt="..."
                                        width="45">
                                    <div class="ms-3"><span
                                            class="h6 d-block fw-normal mb-1 text-sm text-gray-600">Jason
                                            Doe</span><small class="small text-gray-600"> Sent You Message</small>
                            ...
                            <li><a class="dropdown-item d-flex py-3" href="#!"> <img
                                        class="img-fluid rounded-circle flex-shrink-0 avatar shadow-0"
                                        src="<?php echo WEB_ROOT; ?>public/assets/admin/img/avatar-3.jpg" alt="..."
                                        width="45">
                                    <div class="ms-3"><span
                                            class="h6 d-block fw-normal mb-1 text-sm text-gray-600">Jason
                                            Doe</span><small class="small text-gray-600"> Sent You Message</small>
                    ...
                    <!-- <li class="nav-item dropdown"><a class="nav-link dropdown-toggle text-white text-sm" id="languages"
                            rel="nofollow" data-bs-target="#" href="#" data-bs-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false"><img alt="English"><span
                        ...
                        <ul class="dropdown-menu dropdown-menu-end mt-sm-3 shadow-sm" aria-labelledby="languages">
                            <li><a class="dropdown-item" rel="nofollow" href="#!"> <img class="me-2" src=""
                                        alt="English"><span>Việt Nam </span></a></li>
                            <li><a class="dropdown-item" rel="nofollow" href="#!"> <img class="me-2" src=""
                    ...
                    <!-- Log out-->
                    <li class="nav-item"><a class="nav-link text-white text-sm ps-0" href="?action=logout"> <span
                                class="d-none d-sm-inline-block">Đăng xuất</span>
                            <svg class="svg-icon svg-icon-xs svg-icon-heavy">
