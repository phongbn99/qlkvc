...
<div>
    ...
    <nav class="side-navbar">
        <!-- Sidebar Header    -->
        <?php include_once './MVC/views/inc/admin/sidebarheader.php';?>
        ...
        <ul class="list-unstyled">
            ...
            <!-- <li class="sidebar-item"><a class="sidebar-link" href="#demo" data-bs-toggle="collapse">
                    <svg class="svg-icon svg-icon-sm svg-icon-heavy me-xl-2">
                        <use xlink:href="#browser-window-1"> </use>
                    </svg>demo</a>
                <ul class="collapse list-unstyled " id="demo">
                    <li><a class="sidebar-link" href="customer">Khách hàng</a></li>
                    <li><a class="sidebar-link" href="employee">Nhân viên</a></li>
                    <li><a class="sidebar-link" href="#">Trang</a></li>
                </ul>
            </li>
        </ul><span class="text-uppercase text-gray-500 text-sm fw-bold letter-spacing-0 mx-lg-2 heading">Display</span>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-2 col-md-4 col-6 gy-4 gy-xl-0">
                        <div class="d-flex">
                            ...
                            <div class="ms-2">
                                <h3 class="h4 text-dark text-uppercase fw-normal">Dữ liệu người vào</h3>
                                <p class="text-gray-500 small">7 ngày trước</p>
                                <p class="display-6 mb-0">5000</p>
                            </div>
                        </div>
                    </div>
                    <!-- Count item widget-->
                    <div class="col-xl-2 col-md-4 col-6 gy-4 gy-xl-0">
                        <div class="d-flex">
                            ...
                            <div class="ms-2">
                                <h3 class="h4 text-dark text-uppercase fw-normal">Công nhân hoạt động</h3>
                                <p class="text-gray-500 small">1 tháng trước</p>
                                <p class="display-6 mb-0">200</p>
                            </div>
                        </div>
                    </div>
                    <!-- Count item widget-->
                    <div class="col-xl-2 col-md-4 col-6 gy-4 gy-xl-0">
                        <div class="d-flex">
                            ...
                            <div class="ms-2">
                                <h3 class="h4 text-dark text-uppercase fw-normal">Dịch vụ hoạt động</h3>
                                <p class="text-gray-500 small">3 ngày trước</p>
                    ...
                    <div class="col-xl-2 col-md-4 col-6 gy-4 gy-xl-0">
                        <div class="d-flex">
                            ...
                            <div class="ms-2">
                                <h3 class="h4 text-dark text-uppercase fw-normal">Góp ý của khách hàng</h3>
                                <p class="text-gray-500 small">2 ngày trước</p>
                                <p class="display-6 mb-0">4030</p>
                            </div>
                        </div>
                    </div>
                    <!-- Count item widget-->
                    <div class="col-xl-2 col-md-4 col-6 gy-4 gy-xl-0">
                        <div class="d-flex">
                            ...
                            <div class="ms-2">
                                <h3 class="h4 text-dark text-uppercase fw-normal">Dịch vụ trì hoãn</h3>
                                <p class="text-gray-500 small">1 tháng trước</p>
                    ...
                    <div class="col-xl-2 col-md-4 col-6 gy-4 gy-xl-0">
                        <div class="d-flex">
                            ...
                            <div class="ms-2">
                                <h3 class="h4 text-dark text-uppercase fw-normal">Chất lượng đánh giá</h3>
                                <p class="text-gray-500 small">2 tuần trước</p>
                                <p class="display-6 mb-0">4.6 sao</p>
                            </div>
                        </div>
                    </div>
                </div>
